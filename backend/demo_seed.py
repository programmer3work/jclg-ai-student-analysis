...
STUDENT_BRANCHES = {
    12: "MPC", 13: "MPC", 14: "BiPC", 15: "BiPC",
    16: "MEC", 17: "MEC", 18: "CEC", 19: "CEC",
    20: "HEC", 21: "HEC",
}
RISK_BY_STUDENT = {12: "high", 14: "moderate", 16: "high", 18: "moderate", 20: "high"}
RECOMMENDATION_BY_RISK = {
    "high": "Immediate academic support and attendance follow-up recommended.",
    "moderate": "Monitor attendance and provide guided revision support.",
    "low": "Continue regular revision and subject practice.",
}
...
def main():
        ...
        if "stream_id" in insight_columns and "risk_level" in insight_columns:
            for student_id, branch in STUDENT_BRANCHES.items():
                ...
                connection.execute(
                    ...
                    {"stream_id": stream_ids[branch], "risk_level": risk, "recommendation": RECOMMENDATION_BY_RISK[risk], "student_id": student_id},
                )

        exam_rows = connection.execute(text("SELECT exam_id FROM jclg_exam ORDER BY exam_id")).scalars().all()
        exam_names = ["Unit Test 1", "Quarterly Examination", "Half-Yearly Examination"]
    ...
    print("Demo seed applied: BiPC, MEC, CEC, HEC branches; high/moderate risk records; intermediate exam labels; branch alerts.")
